namespace Vintage.AppServices.BusinessClasses
{
    ...
    public class InterRaiCommunityHealth : IValidationTest
    {
        ...
        public InterRaiCommunityHealth()
        {
            this.specificationType = SpecificationType.InterRaiCommunityHealth;
            ...
            this.testFileName = "interRAI_cha_v_3_3_0";
            this.documentTemplate = CdaTemplate.INTERRAI_COMMUNITY_HEALTH_V1;
        }

        static public string GetDescription()
        {
            return "InterRaiCommunityHealth";
        }
        ...
        public List<string> ValidateTestInstance(string testFileName, string encryptionKey)
        {
            ...
            InterRaiCommunityHealthDocument testInstance = new InterRaiCommunityHealthDocument();

            try
            {
                testInstance = new InterRaiCommunityHealthDocument(testFileName);
