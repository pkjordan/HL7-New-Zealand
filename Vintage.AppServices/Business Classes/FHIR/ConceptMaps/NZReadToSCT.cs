namespace Vintage.AppServices.BusinessClasses.FHIR.ConceptMaps
{
    ...
    public class NZReadToSCT
    {
        ...
        private void FillValues(string version, string readcode)
        {
            ...
            this.conceptMap.Name = "NZ Read Codes to SNOMED CT";
            ...
            this.conceptMap.Description = new Markdown("A mapping between the NZ Read Codes and SNOMED CT, published by NHS Digital in Oct 2017 and augmented for use in NZ.");
            ...
            this.conceptMap.Date = new FhirDateTime(2017, 08, 1).Value;
